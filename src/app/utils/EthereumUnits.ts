...
export default class Unit {
	...
	public static USDETH = new Unit(
		'$',
		new BigNumber('388.43'),
		2,
		'ETH-USD',
		'Dollar'
	)
	public static EURETH = new Unit(
		'€',
		new BigNumber('329.22'),
		2,
		'ETH-EUR',
		'Euro'
	)
	public static RUBETH = new Unit(
		'₽',
		new BigNumber('38093'),
		2,
		'ETH-RUB',
	...
	public static AUDETH = new Unit(
		'A$',
		new BigNumber('683.65'),
		2,
		'ETH-AUD',
		'Australian Dollar'
	)
	public static CADETH = new Unit(
		'C$',
		new BigNumber('651.02'),
		2,
		'ETH-CAD',
		'Canadian Dollar'
	)
	public static CHFETH = new Unit(
		'CHF',
		new BigNumber('455.55'),
		2,
		'ETH-CHF',
		'Swiss Franc'
	)
	public static MXNETH = new Unit(
		'MXN',
		new BigNumber('455.55'),
		2,
		'ETH-MXN',
	...
	public static BTCETH = new Unit(
		'₿',
		new BigNumber('455.55'),
		6,
		'ETH-BTC',
		'Bitcoin'
	) // coinbase endpoit: invalid currency :/ workaroung in unit converter
...
export function convertDisplayable(
	value: BigNumber,
	from: Unit,
	to: Unit
): string {
